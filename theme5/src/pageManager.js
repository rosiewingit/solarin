    ...
    <section id="${this.id}" class="body-content">
      ...
      <div class="news-container">
        ...
        <div class="news-body-container">
          ...
          <div class="news-body-cards">
            <div class="row card-item-row">
              <div class="col-md-4 card-item">
                <div id="card-thumbnail-1" class="card-item-top"></div>
                <div class="card-item-bottom">
                  <p>November 28, 2015</p>
                  <h2>솔라인, 2020 대한민국 중소·중견기업 혁신대상 수상</h2>
                  <button type="button" class="btn news-more-button">
                    Learn more
                  </button>
                </div>
              </div>
              <div class="col-md-4 card-item">
                <div id="card-thumbnail-2" class="card-item-top"></div>
                <div class="card-item-bottom">
                  <p>November 28, 2015</p>
                  <h2>솔라인, 2020 대한민국 중소·중견기업 혁신대상 수상</h2>
                  <button type="button" class="btn news-more-button">
              ...
              <div class="col-md-4 card-item">
                <div id="card-thumbnail-3" class="card-item-top"></div>
                <div class="card-item-bottom">
                  <p>November 28, 2015</p>
                  <h2>솔라인, 2020 대한민국 중소·중견기업 혁신대상 수상</h2>
                  <button type="button" class="btn news-more-button">
            ...
            <div class="row card-item-row">
              <div class="col-md-4 card-item">
                <div id="card-thumbnail-4" class="card-item-top"></div>
                <div class="card-item-bottom">
                  <p>November 28, 2015</p>
                  <h2>솔라인, 2020 대한민국 중소·중견기업 혁신대상 수상</h2>
                  <button type="button" class="btn news-more-button">
              ...
              <div class="col-md-4 card-item">
                <div id="card-thumbnail-5" class="card-item-top"></div>
                <div class="card-item-bottom">
                  <p>November 28, 2015</p>
                  <h2>솔라인, 2020 대한민국 중소·중견기업 혁신대상 수상</h2>
                  <button type="button" class="btn news-more-button">
              ...
              <div class="col-md-4 card-item">
                <div id="card-thumbnail-6" class="card-item-top"></div>
                <div class="card-item-bottom">
                  <p>November 28, 2015</p>
                  <h2>솔라인, 2020 대한민국 중소·중견기업 혁신대상 수상</h2>
                  <button type="button" class="btn news-more-button">
            ...
            <div class="row card-item-row">
              <div class="col-md-4 card-item">
                <div id="card-thumbnail-7" class="card-item-top"></div>
                <div class="card-item-bottom">
                  <p>November 28, 2015</p>
                  <h2>솔라인, 2020 대한민국 중소·중견기업 혁신대상 수상</h2>
                  <button type="button" class="btn news-more-button">
              ...
              <div class="col-md-4 card-item">
                <div id="card-thumbnail-8" class="card-item-top"></div>
                <div class="card-item-bottom">
                  <p>November 28, 2015</p>
                  <h2>솔라인, 2020 대한민국 중소·중견기업 혁신대상 수상</h2>
                  <button type="button" class="btn news-more-button">
              ...
              <div class="col-md-4 card-item">
                <div id="card-thumbnail-9" class="card-item-top"></div>
                <div class="card-item-bottom">
                  <p>November 28, 2015</p>
                  <h2>솔라인, 2020 대한민국 중소·중견기업 혁신대상 수상</h2>
                  <button type="button" class="btn news-more-button">
